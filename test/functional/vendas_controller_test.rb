...
class VendasControllerTest < ActionController::TestCase
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post :create, venda: { data_da_venda: @venda.data_da_venda, resposavel_pela_venda: @venda.resposavel_pela_venda }
    end
  ...
  test "should update venda" do
    put :update, id: @venda, venda: { data_da_venda: @venda.data_da_venda, resposavel_pela_venda: @venda.resposavel_pela_venda }
    assert_redirected_to venda_path(assigns(:venda))
  end
